    ...
    <div className="space-y-6 text-gray-100">
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full bg-black border border-gray-800 rounded-lg pl-10 pr-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 transition-colors"
        />
      </div>
                        ...
                        <td className="py-4 px-4 text-right">
                          <div className="inline-flex items-center justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-medium border border-amber-500/40 text-amber-400 hover:bg-amber-500/10 hover:border-amber-500 transition-colors"
                            >
                            ...
                            {!isBanned && (
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-medium border border-red-500/40 text-red-400 hover:bg-red-500/10 hover:border-red-500 transition-colors"
                              >
                                      ...
                                      >
                                        <div>
                                          <div className="flex items-center justify-between gap-2">
                                            ...
                                            {isLeader ? (
                                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 shrink-0">
