  ...
  return (
    <div className="space-y-6">
      ...
      {!scrims || scrims.length === 0 ? (
        <div className="bg-gray-950/50 border border-gray-800 rounded-lg p-12 text-center flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 gap-6">
          {scrims.map((scrim) => {
            ...
            return (
              <div
                key={scrim.id}
                className="bg-gray-950/50 border border-gray-800 rounded-lg p-5 space-y-5 transition-colors hover:border-gray-700/80"
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="self-start md:self-auto bg-gray-900 hover:bg-gray-800 text-gray-200 border border-gray-800 px-4 py-2 rounded-lg text-xs font-semibold transition-colors flex items-center gap-2 cursor-pointer min-h-[44px]"
                    >
                      View Slot Grid
                    </button>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs font-semibold">
                    <span className="text-gray-400">Slot Reservations</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1 border-t border-gray-800/60">
                  <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-900/40 border border-gray-800/50">
                    <div className="w-8 h-8 rounded-lg bg-gray-800/80 flex items-center justify-center flex-shrink-0 text-brand-400">
                      <Clock className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Start Time</div>
                      <div className="text-xs font-bold text-gray-200">{formatTime(scrim.startTime)}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-900/40 border border-gray-800/50">
                    ...
                    <div>
                      <div className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Entry Fee</div>
                      <div className="text-xs font-bold text-gray-200">{formatCurrency(scrim.entryFee)}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-900/40 border border-gray-800/50">
                    ...
                    <div>
                      <div className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Prize Pool</div>
                ...
                <div className="space-y-2 pt-1">
                  <div className="text-xs text-gray-400 font-medium flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-gray-500">Click slot to toggle reservation</span>
                  </div>
                        ...
                        <button
                          ...
                          className={`min-h-[44px] min-w-[44px] rounded flex items-center justify-center px-1 text-xs font-mono transition-all cursor-pointer select-none ${
                            isFilled
                              ...
                              : 'bg-gray-900 border border-gray-800 border-dashed text-gray-500 hover:border-gray-700 hover:text-gray-300'
                          }`}
                        >
