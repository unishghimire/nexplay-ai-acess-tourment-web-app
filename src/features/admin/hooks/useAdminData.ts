    ...
    const handleSaveSettings = async () => {
        try {
            const settingsData = {
                ...
                orgFormDescription,
                discordWebhookTournaments: (discordWebhookTournaments || '').trim(),
