                ...
                {game.modes && game.modes.length > 0 ? (
                    game.modes.map((mode, idx) => {
                        ...
                        <Link
                            ...
                            className="block w-full h-full focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:focus-visible:outline-none rounded-3xl"
                        >
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
