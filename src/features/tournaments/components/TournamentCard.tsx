        ...
        >
            ...
            <div className="h-36 sm:h-48 relative overflow-hidden w-full shrink-0">
                ...
                <div className="absolute top-2 sm:top-4 left-2 sm:left-4 z-20 flex flex-wrap gap-1.5 sm:gap-2 max-w-[calc(100%-4rem)]">
                    <div className="bg-brand-600/90 backdrop-blur-md px-2.5 sm:px-3 py-1 text-[9px] sm:text-[10px] uppercase font-black rounded-full text-white border border-brand-500/30 tracking-widest shadow-xl flex items-center gap-1 sm:gap-1.5 shrink-0 min-h-[24px]">
                        <Gamepad2 className="w-3 h-3 shrink-0" />
                        <span className="truncate max-w-[100px] sm:max-w-none">{formatGameName(tournament.game)}</span>
                    </div>
                    <div className={`backdrop-blur-md px-2.5 sm:px-3 py-1 text-[9px] sm:text-[10px] uppercase font-black rounded-full text-white border tracking-widest shadow-xl flex items-center gap-1 sm:gap-1.5 shrink-0 min-h-[24px] ${
                ...
                <div className="absolute top-2 sm:top-4 right-2 sm:right-4 z-20 flex flex-col gap-1 items-end">
                    <div className="bg-white/10 backdrop-blur-md px-2.5 sm:px-3 py-1 rounded-full border border-white/10 text-[9px] sm:text-[10px] font-black text-white uppercase tracking-widest min-h-[24px] flex items-center justify-center">
                        {tournament.teamType}
                    </div>
                    {(tournament as any).tournamentMode === 'PER_KILL_REWARD' && (
                        <div className="bg-brand-500/20 backdrop-blur-md px-2.5 sm:px-3 py-1 rounded-full border border-brand-500/30 text-[9px] sm:text-[10px] font-black text-brand-400 uppercase tracking-widest min-h-[24px] flex items-center gap-1">
                ...
                <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 right-2 sm:right-4 z-20">
                    <div className="flex flex-col min-w-0">
                        <span className="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest mb-0.5">Prize Pool</span>
            ...
            <div className="p-4 sm:p-6 flex-grow flex flex-col bg-gradient-to-b from-surface to-dark/50 min-w-0">
                ...
                <div className="space-y-3 sm:space-y-4 mt-auto">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 pt-2">
                        ...
                        <div className="inline-flex items-center justify-center min-h-[44px] gap-1.5 bg-brand-600/10 text-brand-500 px-3.5 sm:px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest group-hover:bg-brand-600 group-hover:text-white transition-all duration-300 shrink-0">
